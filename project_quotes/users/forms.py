...
class RegisterForm(UserCreationForm):
    ...
    password1 = CharField(min_length=6, max_length=24, required=True,
                          widget=PasswordInput(attrs={"class": "form-control"}))
    password2 = CharField(min_length=6, max_length=24, required=True,
                          widget=PasswordInput(attrs={"class": "form-control"}))
...
class LoginForm(AuthenticationForm):
    ...
    password = CharField(max_length=24, min_length=6, required=True,
                         widget=PasswordInput(attrs={"class": "form-control"}))
    # password = CharField()
